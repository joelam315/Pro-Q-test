...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    need_login_verify=models.BooleanField(default=False)
    login_token=models.CharField(max_length=12)
...
class Address(models.Model):
    ...
    lat=models.FloatField(blank=True, null=True,validators=[MinValueValidator(-90), MaxValueValidator(90)])
    lng=models.FloatField(blank=True, null=True,validators=[MinValueValidator(-180), MaxValueValidator(180)])
...
class Comment(models.Model):
    ...
    company = models.ForeignKey(
        'companies.Company', blank=True, null=True,
        related_name="companies_comments",
        on_delete=models.CASCADE)
    ...
    quotation = models.ForeignKey('quotations.Quotation', blank=True, null=True,
                                related_name='quotation_comments', on_delete=models.CASCADE)
...
class Attachments(models.Model):
    ...
    company = models.ForeignKey(
        ...
        related_name='company_attachment', on_delete=models.CASCADE)
    contact = models.ForeignKey(
    ...
    quotation = models.ForeignKey('quotations.Quotation', blank=True, null=True,
                                related_name='quotation_attachment', on_delete=models.CASCADE)
    event = models.ForeignKey('events.Event', blank=True, null=True,
...
class APISettings(models.Model):
    ...
    tags = models.ManyToManyField('companies.Tags', blank=True)
    created_by = models.ForeignKey(
