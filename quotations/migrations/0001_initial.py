...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0011_auto_20200504_1823'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quotation_title', models.CharField(max_length=50, verbose_name='Quotation Title')),
                ('quotation_number', models.CharField(max_length=50, verbose_name='Quotation Number')),
                ...
                ('accounts', models.ManyToManyField(related_name='accounts_quotations', to='accounts.Account')),
                ('assigned_to', models.ManyToManyField(related_name='quotation_assigned_to', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotation_created_by', to=settings.AUTH_USER_MODEL)),
                ('from_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotation_from_address', to='common.Address')),
                ('teams', models.ManyToManyField(related_name='quotations_teams', to='teams.Teams')),
                ('to_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotation_to_address', to='common.Address')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.TextField(blank=True, null=True, verbose_name='Details')),
                ('due_date', models.DateField(blank=True, null=True)),
                ('assigned_to', models.ManyToManyField(related_name='quotation_history_assigned_to', to=settings.AUTH_USER_MODEL)),
                ('from_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotation_history_from_address', to='common.Address')),
                ('quotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotation_history', to='quotations.Quotation')),
                ('to_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotation_history_to_address', to='common.Address')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotation_history_created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('created_on',),
            },
