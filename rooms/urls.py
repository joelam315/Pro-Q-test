...
urlpatterns = [
    ...
    path('room_formula/create/',CreateRoomTypeFormulaView.as_view(),name="add_room_type_formula"),
    path('room_formula/edit/<int:pk>',UpdateRoomTypeFormulaView.as_view(),name="edit_room_type_formula"),
    path('room_formula/delete/',RemoveRoomTypeFormulaView.as_view(),name="remove_room_type_formula"),
