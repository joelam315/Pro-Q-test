...
class TaskCreateTest(object):
    ...
    def setUp(self):
        ...
        self.task.company = self.company
        self.task.save()

        self.company.assigned_to.add(self.user1)
...
class TaskDeleteTestCase(TaskCreateTest, TestCase):
    ...
    def test_task_delete(self):
        ...
        response = self.client.get(
            reverse('tasks:task_delete', args=(self.task_1.id,)) + '?view_company={}'.format(self.company.id))
        self.assertEqual(response.status_code, 302)
