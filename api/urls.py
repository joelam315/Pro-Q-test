...
urlpatterns = [
	...
	path('general_remarks/set/',SetQuotationGeneralRemarksView.as_view(),name="set_general_remarks"),
	path('general_remarks/get/',GetQuotationGeneralRemarksView.as_view(),name="get_general_remarks"),
